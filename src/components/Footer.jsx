                    ...
                    <div className="col-md-4 d-flex align-items-center">
                         ...
                         <svg className="bi" width="30" height="24" aria-hidden="true">
                            ...
                            <span className="mb-3 mb-md-0 text-body-secondary">© 2025 Company, Inc</span> 
                                ...
                                <li className="ms-3"><a className="text-body-secondary" href="#" aria-label="Instagram">
                                    <svg className="bi" width="24" height="24" aria-hidden="true"><use xlink:href="#instagram">
                                        </use></svg></a></li> <li className="ms-3">
                                            <a className="text-body-secondary" href="#" aria-label="Facebook">
                                                <svg className="bi" width="24" height="24"><use xlink:href="#facebook">
                                                    </use></svg></a></li> 
                                                    </ul> 
                                                    </footer> </div>
        </>
